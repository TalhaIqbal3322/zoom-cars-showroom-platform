...
$sql1 = "UPDATE login SET email='$email' WHERE user_type='Admin'";
  if (mysqli_query($conn, $sql1)) {
   ?>
   <script type="text/javascript">
    alert("Update Successfully.");
...
$query_chck_pass = mysqli_query($conn,"SELECT * FROM login WHERE password='$current_pass' AND user_type='Admin'") or die(mysqli_error($conn)); 
...
$new_pass=$base4.$md5.$base4;
    ...
    $query1="UPDATE login set password='$new_pass' WHERE user_type='Admin'";
                ...
                <form action="" method="POST">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="" readonly required name="project_name" class="form-control" placeholder="Enter Name" value="Zoom Cars">
                    </div>
                ...
                <form action="" method="POST">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" required name="email" class="form-control" placeholder="Enter Email" value="<?php $query = "SELECT * FROM login WHERE user_type='Admin'"; $result = mysqli_query($conn, $query); $row = mysqli_fetch_array($result); echo $row['email'];?>">
                    </div>
